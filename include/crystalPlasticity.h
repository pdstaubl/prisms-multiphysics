...
public:
  ...
  *calculates the incremental shear strain in the slip systems by active set search and removal of inactive slip systems
  ...
  PA-active slip systems
  */
  void inactive_slip_removal(Vector<double> &active,Vector<double> &x_beta_old, Vector<double> &x_beta, unsigned int &n_PA, unsigned int &n_Tslip_systems_Region, Vector<double> &PA, Vector<double> b,FullMatrix<double> A,FullMatrix<double> &A_PA,unsigned int &n_Tslip_systems_RegionWOtwin);
  /**
...
private:
  ...
  */
  ...
  std::vector<std::vector<  std::vector<double> > >  twinfraction_iter, slipfraction_iter,twinfraction_conv, slipfraction_conv,TwinOutputfraction_iter,TwinOutputfraction_conv,energy,dtwinfraction_iter;
