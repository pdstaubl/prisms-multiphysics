  ...
  try
    {
      ...
      userInputParameters_pf<3> userInputs_pf(input_file_reader,
      ...
      problem.orientations.loadOrientationVector(userInputs_cp.grainOrientationsFile,
                                                 userInputs_cp.enableMultiphase,
                                                 userInputs_cp.additionalVoxelInfo);
